               ...
               <div class="panel-body">
                     ...
                     <?php if (isset($member)) { ?>
                        ...
                        <li role="presentation">
                           <a href="#staff_contract" aria-controls="staff_contract" role="tab" data-toggle="tab">
                              ...
                              <?php echo _l('staff_contract'); ?>
                           </a>
                        </li>
                        <li role="presentation">
                           <a href="#insurrance" aria-controls="insurrance" role="tab" data-toggle="tab">
                              <i class="fa fa-medkit hrm-fontsize15"></i>&nbsp;
                              <?php echo _l('insurrance'); ?>
                           </a>
                        </li>
                  ...
                  <div class="tab-content">
                     <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                        ...
                        <?php if ((isset($member) && $member->profile_image == NULL) || !isset($member)) { ?>
                           <div class="form-group">
                              <label for="profile_image" class="profile-image">
                                 <?php echo _l('staff_edit_profile_image'); ?>
                              </label>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="form-group" app-field-wrapper="staff_identifi">
                                 <label for="staff_identifi" class="control-label">
                                    <?php echo _l('hr_code'); ?>
                                 </label>
                                 <input type="text" id="staff_identifi" name="staff_identifi" class="form-control"
                                    value="<?php echo htmlspecialchars($hr_codes); ?>" aria-invalid="false" <?php if (!is_admin() && !hrm_permissions('hrm', '', 'edit')) {
                                          echo 'disabled';
                                       } ?>>
                              </div>
                           </div>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <label for="status_work" class="control-label">
                                 <?php echo _l('status_work'); ?>
                              </label>
                              <select name="status_work" class="selectpicker" id="status_work" data-width="100%"
                                 data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 <option value=""></option>
                           ...
                           <div class="col-md-4">
                              ...
                              <select name="job_position" class="selectpicker" id="job_position" data-width="100%"
                                 data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 <option value=""></option>
                           ...
                           <div class="col-md-4">
                              <label for="workplace" class="control-label">
                                 <?php echo _l('workplace'); ?>
                              </label>
                              <select name="workplace" class="selectpicker" id="workplace" data-width="100%"
                                 data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                 <option value=""></option>
                                 <?php foreach ($workplace as $w) { ?>
                                    ...
                                    <option value="<?php echo htmlspecialchars($w['workplace_id']); ?>" <?php if (isset($member) && $member->workplace == $w['workplace_id']) {
                                       ...
                                       <?php echo htmlspecialchars($w['workplace_name']); ?>
                                    </option>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label for="facebook" class="control-label"><i class="fa fa-facebook"></i>
                                    <?php echo _l('staff_add_edit_facebook'); ?>
                                 </label>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label for="linkedin" class="control-label"><i class="fa fa-linkedin"></i>
                                    <?php echo _l('staff_add_edit_linkedin'); ?>
                                 </label>
                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label for="skype" class="control-label"><i class="fa fa-skype"></i>
                                    <?php echo _l('staff_add_edit_skype'); ?>
                                 </label>
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <div class="form-group" app-field-wrapper="email">
                                 ...
                                 <input type="email" id="email" name="email" class="form-control" autocomplete="off"
                                    value="<?php echo htmlspecialchars($value); ?>" <?php if (!is_admin() && !hrm_permissions('hrm', '', 'edit')) {
                                          echo 'disabled';
                                       } ?>>
                              </div>
                                 ...
                                 <div class="form-group select-placeholder">
                                    ...
                                    <select name="default_language" data-live-search="true" id="default_language"
                                       ...
                                       <?php foreach ($this->app->get_available_languages() as $availableLanguage) {
                                          ...
                                          ?>
                                          <option value="<?php echo htmlspecialchars($availableLanguage); ?>" <?php echo htmlspecialchars($selected); ?>>
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="form-group select-placeholder">
                                 <label for="direction">
                                    <?php echo _l('document_direction'); ?>
                                 </label>
                           ...
                           <div class="form-group">
                              <?php if (count($departments) > 0) { ?>
                                 <label for="departments">
                                    <?php echo _l('staff_add_edit_departments'); ?>
                                 </label>
                              <?php } ?>
                              <?php foreach ($departments as $department) { ?>
                                 <div class="checkbox checkbox-primary">
                                    ...
                                    ?>
                                    <input type="checkbox"
                                       id="dep_<?php echo htmlspecialchars($department['departmentid']); ?>"
                                       name="departments[]"
                                       value="<?php echo htmlspecialchars($department['departmentid']); ?>" <?php echo htmlspecialchars($checked); ?>>
                                    <label for="dep_<?php echo htmlspecialchars($department['departmentid']); ?>">
                              ...
                              <?php if (is_admin()) { ?>
                                 <div class="checkbox checkbox-primary">
                                    ...
                                    <label for="administrator">
                                       <?php echo _l('staff_add_edit_administrator'); ?>
                                    </label>
                                 </div>
                              <?php } ?>
                        ...
                        <div role="tabpanel" class="tab-pane" id="insurrance">
                           <div class="insurance-info">
                              <div class="row publib-insurance-title">
                                 <div class="col-md-8">
                                    <h4>
                                       <span class="publib-infor">
                                          <?php echo _l('insurance_info') ?>
                                       </span>
                                    </h4>
                                 </div>
                              </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="form-group" app-field-wrapper="contract_code">
                                          <div class="row">
                                             <div class="col-md-6">
                                                <h4 class="contract_info bold">
                                                   <?php echo _l('insurance_book_number') ?>:
                                                </h4>
                                             </div>
                                             <div class="col-md-6">
                                                <h4 class="contract_info">
                                                   <?php echo htmlspecialchars($insurance_book_num); ?>
                                                </h4>
                                             </div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <h4 class="contract_info bold">
                                                <?php echo _l('health_insurance_number') ?>:
                                             </h4>
                                          </div>
                                          <div class="col-md-6">
                                             <h4 class="contract_info">
                                                <?php echo htmlspecialchars($health_insurance_num); ?>
                                             </h4>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <h4 class="contract_info bold">
                                                <?php echo _l('province_city_id') ?>:
                                             </h4>
                                          </div>
                                          <div class="col-md-6">
                                             <h4 class="contract_info">
                                                <?php echo htmlspecialchars($city_code); ?>
                                             </h4>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       <div class="row">
                                          <div class="col-md-6">
                                             <h4 class="contract_info bold">
                                                <?php echo _l('registration_medical_care') ?>:
                                             </h4>
                                          </div>
                                          <div class="col-md-6">
                                             <h4 class="contract_info">
                                                <?php echo htmlspecialchars($registration_medical); ?>
                                             </h4>
                                          </div>
                                       </div>
