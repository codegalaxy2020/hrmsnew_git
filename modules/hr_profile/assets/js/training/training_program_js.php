...
function edit_training_process(invoker,id, rec_evaluation_form_id){
	...
	$('#job_position_training input[name="training_location"]').val($(invoker).data('training_location'));
	$('#job_position_training input[name="training_venues"]').val($(invoker).data('training_venues'));
	...
	$('#job_position_training input[name="indirect_cost"]').val($(invoker).data('indirect_cost'));
	$('#job_position_training input[name="direct_cost"]').val($(invoker).data('direct_cost'));
	$('#job_position_training select[name="training_type"]').change();
	$.post(admin_url + 'hr_profile/get_list_job_position_training/'+id).done(function(response) {
		...
		$('#special_needs').val(response.special_needs);
        $('#expectation_from_training').val(response.expectation_from_training);
		$('.selectpicker').selectpicker({
		});
	});
