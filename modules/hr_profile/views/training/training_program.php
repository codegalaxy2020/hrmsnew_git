				...
				<div class="modal-body">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="interview_infor">
							...
							<div class="row">
							 <div class="col-md-3">
								<div class="form-group" app-field-wrapper="slots">
								    <label for="slots" class="control-label"> 
								    <small class="req text-danger">* </small>Slots</label>
								    <input type="text" id="slots" name="slots" class="form-control" value="">
								</div>
							</div>
							<div class="col-md-3">
...
<script>
    $(document).ready(function () {
        ...
        // Attach a click event to the feedback button
        $('.feedback-btn').on('click', function () {
            // Extract the training ID from the row
            var trainingId = $(this).data('training-id');

            // Open the modal with the feedback form
            openFeedbackModal(trainingId);
        });

        // Function to open the feedback modal
        function openFeedbackModal(trainingId) {
            // Use JavaScript or a library of your choice to open the modal
            // You might need to customize this based on your modal implementation
            // Example using Bootstrap modal
            $('#feedbackModal').modal('show');

            // Optionally, you can also send the training ID to the modal for processing
            $('#trainingIdInput').val(trainingId);
        }
    });
</script>