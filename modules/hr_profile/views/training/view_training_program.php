				...
				<div class="panel_s">
					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-12 panel-padding">
								<table class="table border table-striped table-margintop">
									<tbody>
										...
										<?php } ?>
                                            <tr class="project-overview">
												<td class="bold">Training Location</td>
												<td><?php echo $training_program->training_location; ?></td>
											</tr>
											<tr class="project-overview">
												<td class="bold">Training Venues</td>
												<td><?php echo $training_program->training_venues ; ?></td>
											</tr>
							...
							<div class="col-md-12">
								<h4 class="h4-color">Special Needs</h4>
								<hr class="hr-color">
								<h5><?php echo html_entity_decode($training_program->special_needs) ; ?></h5>

							</div>
							<div class="col-md-12">
								<h4 class="h4-color">Expectation From Training</h4>
								<hr class="hr-color">
								<h5><?php echo html_entity_decode($training_program->expectation_from_training) ; ?></h5>
