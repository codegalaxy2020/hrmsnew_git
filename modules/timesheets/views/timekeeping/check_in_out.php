...
<input type="hidden" name="token_name" id="token_name" value="<?= $CI->security->get_csrf_token_name() ?>">
<input type="hidden" name="token_hash" id="token_hash" value="<?= $CI->security->get_csrf_hash() ?>">
...
<div class="modal" id="clock_attendance_modal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="hidden" name="default_staff_id" id="default_staff_id" value="<?= get_staff_user_id() ?>">
            ...
            <div class="col-md-12 bottom_co_btn">
              <div class="bottom_co_btn_item">
                ...
                if ($type_check_in_out == '' || $type_check_in_out == 2 || $allows_updating_check_in_time == 1 || is_admin()) {
                  ...
                  <button class="btn btn-primary check_in">
                    <?php echo _l('check_in'); ?>
                  </button>
                  <?php echo form_close();
                } ?>
