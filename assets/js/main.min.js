...
function view_event(e) {
        var urlSegment = window.location.pathname.split('/')[4];
        var endpoint;
        if (urlSegment === 'calendartraining') {
            endpoint = "utilities/view_event_training/";
        } else {
            endpoint = "utilities/view_event/";
        }
        var requestUrl = admin_url + endpoint + e;
        
        void 0 !== e &&
        $.post(requestUrl).done(function (e) {
            ...
            var o = {
                ...
                eventSources: [
                    function (e, t, a) {
                        ...
                        // Check if the third URI segment is "calendartraining"
                        if (window.location.pathname.split('/')[4] === "calendartraining") {
                            apiUrl = admin_url + "utilities/get_calendar_data_training";
                        } else {
                            apiUrl = admin_url + "utilities/get_calendar_data";
                        }
                        ...
                        return (
                            ...
                            $.getJSON(apiUrl, $.extend({}, i, { start: e.startStr, end: e.endStr })).then(function (e) {
                                t(
                                    e.map(function (e) {
